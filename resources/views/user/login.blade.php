...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    ...
    <section class="mt-10">
        <form action="/admin/process" method="POST" class="flex flex-col">
            @csrf
            @error('email')
            ...
            <label for="email" class="block text-gray-700 text-sm font-bold 
                ...
                focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off">
            </div>
            <div class="mb-6 pt-3 rounded bg-gray-200">
            ...
            duration-200" type="submit">Login</button>
        </form>
    </section>
</main>
