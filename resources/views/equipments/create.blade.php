...
<header class="max-w-lg mx-auto">
    <a href="#">
        <h1 class="text-4xl font-bold text-white text-center">Add New Equipment</h1>
    </a>
</header>
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    ...
    <section class="mt-10">
        <form action="/admin/equipment/add" method="POST" class="flex flex-col" enctype="multipart/form-data"> 
        @csrf
