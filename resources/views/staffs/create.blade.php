...
<header class="max-w-lg mx-auto">
    <a href="#">
        <h1 class="text-4xl font-bold text-white text-center">Add New Staff</h1>
    </a>
</header>
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    ...
    <section class="mt-10">
        <form action="/admin/staff/add" method="POST" class="flex flex-col" enctype="multipart/form-data">
            @csrf
            <div class="mt-6 mb-6 pt-3 rounded bg-gray-200"> <!-- FIRST NAME -->
                <label for="first_name" class="block text-gray-700 text-sm font-bold 
                    ...
                    focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value={{old('first_name')}}>
                    @error('first_name')
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200"> <!-- LAST NAME -->
                    <label for="last_name" class="block text-gray-700 text-sm font-bold 
                        ...
                        focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value={{old('last_name')}}>
                    @error('last_name')
                    <p class="text-red-500 text-xs p-1">
                        {{$message}}
                    </p>
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200"> <!-- designation -->
                    <label for="designation" class="block text-gray-700 text-sm font-bold 
                        ...
                        focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value={{old('designation')}}>
                    @error('designation')
                    <p class="text-red-500 text-xs p-1">
                        {{$message}}
                    </p>
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200"> <!-- expertise -->
                    <label for="expertise" class="block text-gray-700 text-sm font-bold 
                        ...
                        focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value={{old('expertise')}}>
                    @error('expertise')
                    <p class="text-red-500 text-xs p-1">
                        {{$message}}
                    </p>
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200"> <!-- contact num -->
                    <label for="contact_num" class="block text-gray-700 text-sm font-bold 
                        ...
                        focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value={{old('contact_num')}}>
                    @error('contact_num')
                    <p class="text-red-500 text-xs p-1">
                        {{$message}}
                    </p>
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200"> <!-- emer contact num -->
                    <label for="emer_contact_num" class="block text-gray-700 text-sm font-bold 
                        ...
                        focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value={{old('emer_contact_num')}}>
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200"> <!-- staff photo -->
                    <label for="staff_photo" class="block text-gray-700 text-sm font-bold 
                        ...
                        focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value={{old('staff_photo')}}>
                    @error('staff_photo')
                    <p class="text-red-500 text-xs p-1">
                        {{$message}}
                    </p>
